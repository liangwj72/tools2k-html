    ...
    <nav class="navbar navbar-default  navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand"><label class="system-name"><my-key vkey="system.name"></my-key></label></a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <!-- 功能菜单区域   开始  -->
          <ul class="nav navbar-nav ">
            <router-link activeClass="active" tag="li" v-for="row in menus" :to="row.path" :key="row.path"><a href="javascript:">{{row.name}}</a>
            </router-link>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"><a href="javascript:" class="dropdown-toggle" data-toggle="dropdown">您好：{{username}} <span
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="/dev/" target="_blank">开发调试</a></li>
              </ul>
            </li>
          </ul>
        </div>
