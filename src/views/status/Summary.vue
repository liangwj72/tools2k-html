                ...
                <el-col :span="12">
                    <el-card class="small-header">
                        ...
                        <el-form class="info-form"
                            ...
                            <el-form-item label="启动时间:" class="text-caption">{{vm.startTime | timeFormat}}
                            </el-form-item>
                ...
                <el-col :span="12">
                    <el-card class="small-header">
                        ...
                        <el-form class="info-form"
                                 labelPosition="left"
                                 label-width="120px">
                            <el-form-item label="总物理内存:" class="text-caption">{{os.totalPhysicalMemorySize | sizeToM}}
                            </el-form-item>
                            <el-form-item label="空闲物理内存:" class="text-caption">{{os.freePhysicalMemorySize | sizeToM}}
                            </el-form-item>
                            <el-form-item label="总交换空间:" class="text-caption">{{os.totalSwapSpaceSize | sizeToM}}
                            </el-form-item>
                            <el-form-item label="提交的虚拟内存:" class="text-caption">{{os.committedVirtualMemorySize |
                                sizeToM}}
                            </el-form-item>
                ...
                <el-col :span="12">
                    ...
                    <el-card class="small-header">
                        ...
                        <el-form class="info-form"
                            ...
                            <el-form-item label="线程峰值:" class="text-caption">{{threading.peakThreadCount}}
                            </el-form-item>
                            <el-form-item label="守护程序线程:" class="text-caption">{{threading.daemonThreadCount}}
                            </el-form-item>
                            <el-form-item label="累计启动线程数:" class="text-caption">{{threading.totalStartedThreadCount}}
                            </el-form-item>
                        </el-form>
                    </el-card>
                    <!-- /线程  -->
                ...
                <el-col :span="12">
                    ...
                    <el-card class="small-header">
                        ...
                        <el-form class="info-form"
                                 labelPosition="left"
                                 label-width="120px">
                            <el-form-item label="当前加载类:" class="text-caption">{{classLoading.loadedClassCount}}
                            </el-form-item>
                            <el-form-item label="累计加载类总数:" class="text-caption">{{classLoading.totalLoadedClassCount}}
                            </el-form-item>
                            <el-form-item label="已卸载类总数:" class="text-caption">{{classLoading.unloadedClassCount}}
                            </el-form-item>
                        </el-form>
